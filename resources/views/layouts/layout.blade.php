...
<body>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="bootcampsDropdown">
                            <a class="dropdown-item" href="{{ route('index') }}#bootcamplink">Full Stack Developer</a>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="https://instagram.com/devden_academy?igshid=MzRlODBiNWFlZA==" target="_blank" class="nav-link text-white" style="font-size: 22px;"><img src="{{ asset('IMG/Post/Iconos/Instagram.png') }}" alt="Instagram" style="width: 24px;"></a>
                    </li>
                    <li class="nav-item">
                        <a href="https://www.facebook.com/profile.php?id=61550068195611&sk=followers" target="_blank" class="nav-link text-white" style="font-size: 22px;"><img src="{{ asset('IMG/Post/Iconos/Facebook.png') }}" alt="Facebook" style="width: 24px;"></a>
                    </li>
                    <li class="nav-item">
                        <a href="https://www.linkedin.com/company/devden-academy/" target="_blank" class="nav-link text-white" style="font-size: 22px;"><img src="{{ asset('IMG/Post/Iconos/Linkedln.png') }}" alt="LinkedIn" style="width: 28px;"></a>
                    </li>
                </ul>
            </div>
        </div>
  ...
  <div class="floating-icon">
    <a href="https://wa.me/64162727" target="_blank">
      <img style="width: 54px; height: 54px;" src="{{ asset('IMG/post/Iconos/image_whatsapp.png') }}" alt="">
    </a>
  </div>
